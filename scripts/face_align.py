#!/usr/bin/env python3
"""
Face Alignment Script
Run from project root: python scripts/face_align.py
"""
import sys
import os
import time
...
# detector = Yolov5Face(model_file=os.path.join(PROJECT_ROOT, "ml/detection/yolov5_face/weights/yolov5n-0.5.pt"))
