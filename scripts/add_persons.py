#!/usr/bin/env python3
"""
Add Persons Script - Add new persons to the face recognition database
Run from project root: python scripts/add_persons.py
"""
import argparse
import os
import sys
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--backup-dir",
        type=str,
        default=os.path.join(PROJECT_ROOT, "datasets/backup"),
        help="Directory to save person data.",
    )
    parser.add_argument(
        "--add-persons-dir",
        type=str,
        default=os.path.join(PROJECT_ROOT, "datasets/new_persons"),
        help="Directory to add new persons.",
    )
    parser.add_argument(
        "--faces-save-dir",
        type=str,
        default=os.path.join(PROJECT_ROOT, "datasets/data/"),
        help="Directory to save faces.",
    )
    parser.add_argument(
        "--features-path",
        type=str,
        default=os.path.join(PROJECT_ROOT, "datasets/face_features/feature"),
