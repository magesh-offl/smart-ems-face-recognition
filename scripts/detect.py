...
Run from project root: python scripts/detect.py
"""
import sys
import os
import time
...
# detector = Yolov5Face(model_file=os.path.join(PROJECT_ROOT, "ml/detection/yolov5_face/weights/yolov5m-face.pt"))
