...
from app.core.interfaces.service import IBatchRecognitionService
...
class BatchRecognitionService(IBatchRecognitionService):
    ...
    def process_image(self, image_path: str) -> Dict[str, Any]:
        ...
        # Generate batch ID
        batch_id = BatchRecognitionLogSchema.generate_batch_id()
        ...
        for result in results:
            doc = BatchRecognitionLogSchema.get_document(
