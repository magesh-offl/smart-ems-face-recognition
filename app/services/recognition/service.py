...
class RecognitionService(IRecognitionService):
    ...
    def save_recognition(self, person_name: str, camera_id: str,
        ...
        return self.repo.create_or_update_log(person_name, camera_id, confidence_score)
    ...
    def get_all_logs(self, skip: int = 0, limit: int = 10) -> List[Dict[str, Any]]:
        ...
        return self.repo.get_all_logs(skip, limit)
    ...
    def filter_logs(self, person_name: Optional[str] = None,
        ...
        return self.repo.get_logs_with_filter(person_name, camera_id, start_date, end_date, skip, limit)
    ...
    def update_log(self, log_id: str, person_name: Optional[str] = None,
        ...
        return self.repo.update_log(log_id, person_name, camera_id, confidence_score)
    ...
    def get_total_count(self, person_name: Optional[str] = None,
        ...
        return self.repo.get_total_count(person_name, camera_id)
