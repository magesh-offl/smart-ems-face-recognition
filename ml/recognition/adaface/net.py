"""AdaFace Network Architecture

Original implementation from: https://github.com/mk-minchul/AdaFace
...
def build_model(model_name='ir_50'):
    ...
    if model_name == 'ir_101':
        ...
        return IR_101(input_size=(112, 112))  # ir_100 and ir_101 are the same
    else:
